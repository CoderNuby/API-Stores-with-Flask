...
blp = Blueprint("Tag", "tags", description="Operations on tags")
...
class TagsInStore(MethodView):
    ...
    def post(self, tag_data, store_id):
        ...
        TagModel.name == tag_data["name"]).first():
            abort(400, message="This name tag is already exists in that store")    
...
class LinkTagsToItem(MethodView):
    ...
    def delete(self, item_id, tag_id):
        ...
        return {"message": "Tag removed success"}
...
class Tag(MethodView):
    ...
    @blp.response(
        200,
        description="Deletes a tag if no item is tagge with it.",
